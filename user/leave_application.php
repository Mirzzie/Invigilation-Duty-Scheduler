...
if(isset($_POST['submit'])){
  ...
  $reason = $_POST['reason'];
  $sql = "INSERT INTO leave_list (fid,leave_type_id,date,reason,status,date_approved,date_created) VALUES ($fac_id,$leave_type,'$leave_date','$reason',0,NULL,current_timestamp())";
  $result = $conn->query($sql);
  if($result){
